...
INSERT INTO public.problems (slug, name_he, name_en, parent_id, is_active)
SELECT 'personality_disorders', 'הפרעות אישיות', 'Personality Disorders', NULL, true
WHERE NOT EXISTS (SELECT 1 FROM public.problems WHERE slug = 'personality_disorders');

INSERT INTO public.problems (slug, name_he, name_en, parent_id, is_active)
SELECT 'sexual_abuse_trauma', 'פגיעות מיניות וטראומה מינית', 'Sexual Abuse & Sexual Trauma', NULL, true
