-- Admin-public profile editor mode.
-- Keeps self-service ownership unchanged while allowing a trusted Tipulinks
-- admin to create/update an unclaimed profile without becoming its owner.
