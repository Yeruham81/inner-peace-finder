...
function buildSteps(status: ProfileOnboardingStatus): Step[] {
    ...
    status.accountStatus === "suspended"
      ...
      : status.ownershipMode === "claimed"
        ...
        : status.ownershipMode === "self_created"
          ...
          : "החשבון נפתח ולאחר שמירת הפרופיל הוא ישויך אליו אוטומטית";

  const credentialCopy: Record<ProfileOnboardingStatus["credentialState"], [string, string]> = {
    not_started: ["אימות הסמכות ותארים", "העלאת מסמכים המעידים על תארים, הסמכות והכשרות מקצועיות (למי שמעוניין)"],
  ...
  return [
    ...
    },
    {
      ...
      description: "הגדרת הערוצים שבהם ניתן לפנות אליכם כדי לתאם טיפול",
