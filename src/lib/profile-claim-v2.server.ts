...
function inviteEmailHtml(invite: ClaimInvite): string {
  ...
  return `<div dir="rtl" style="font-family:Arial,sans-serif;max-width:620px;margin:auto;color:#18302b;line-height:1.75">
    ...
    <p>נעים להכיר — טיפולינקס היא פלטפורמה חדשה ומתקדמת שמסייעת למצוא בקלות וביעילות אנשי מקצוע ממגוון תחומי הטיפול.</p>
    ...
    <ul style="padding-right:22px;margin:0 0 18px">
      ...
      <li>פניות ממוקדות מאנשים שמעוניינים לתאם טיפול.</li>
    ...
    <p style="font-size:13px;color:#687873">לא מעוניינים להופיע בטיפולינקס? ניתן להיכנס <a href="${profileUrl}" style="color:#2d8074">לעמוד הפרופיל</a> ולבקש להסיר אותו.</p>
  </div>`;
}
