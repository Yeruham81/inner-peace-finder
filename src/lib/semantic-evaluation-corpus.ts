...
export const CLASSIFICATION_CASES: SemanticCase[] = [
  ...
  { input: "אני פוחדת לצאת מהבית ולפגוש אנשים", expected: ["anxiety"], category: "natural_language" },
  { input: "יש לי התקפי חרדה באמצע היום בלי סיבה", expected: ["anxiety"], category: "natural_language" },
  { input: "אחרי השירות הצבאי אני חווה פלאשבקים וסיוטים", expected: ["trauma"], category: "natural_language" },
  { input: "אני שחוקה לגמרי מהעבודה ולא מצליחה להתאושש", expected: ["burnout"], category: "natural_language" },
  { input: "אני לא מסתדרת עם בן הזוג שלי כבר חודשים", expected: ["relationships"], category: "natural_language" },
  ...
  { input: "אני מרגיש בודד גם כשאני עם אנשים", expected: ["social_belonging"], category: "natural_language" },
  { input: "יש לי בעיה עם אוכל, אני אוכלת ואז מתחרטת", expected: ["eating_disorders"], category: "natural_language" },
  {
  ...
  { input: "אני כועס על כולם כל הזמן ולא מבין למה", expected: ["emotional_regulation"], category: "natural_language" },
  { input: "עוברת גירושין ומרגישה שהעולם מתפרק", expected: ["relationships"], category: "natural_language" },
  {
    input: "אני דוחה כל דבר לרגע האחרון ואז זה מתפוצץ לי",
    expected: ["performance_functioning"],
    category: "natural_language",
  },
  { input: "מרגיש שאין לי ערך ושכולם טובים ממני", expected: ["self_identity"], category: "natural_language" },
  { input: "אני מפחדת שיש לי מחלה קשה ורצה כל הזמן לרופאים", expected: ["anxiety"], category: "natural_language" },
  {
  ...
  { input: "אחרי הפרידה אני לא מצליח לחזור לעצמי", expected: ["relationships"], category: "natural_language" },
  {
  ...
  { input: "יש לי כאבים בגוף בלי סיבה", expected: ["somatic"], category: "ambiguous", allowLowConfidence: true },
  ...
  { input: "אחרי טראומה מהצבא יש לי גם התקפי פאניקה", expected: ["trauma", "anxiety"], category: "multiple_domains" },
  {
  ...
  { input: "התמכרות לסמים אחרי טראומה בילדות", expected: ["addiction", "trauma"], category: "multiple_domains" },
  {
  ...
  { input: "אין לי אוויר כבר", expected: ["emotional_regulation"], category: "slang", allowLowConfidence: true },
  { input: "אני על הפנים", expected: ["depression"], category: "slang", allowLowConfidence: true },
  { input: "אני בדאון רציני", expected: ["depression"], category: "slang", allowLowConfidence: true },
  { input: "אני מתפרק לחתיכות", expected: ["emotional_regulation"], category: "slang", allowLowConfidence: true },
  { input: "המוח שלי לא נותן לי מנוח", expected: ["ocd_compulsions"], category: "slang", allowLowConfidence: true },
  { input: "אני לא סובלת את עצמי", expected: ["self_identity"], category: "slang", allowLowConfidence: true },
