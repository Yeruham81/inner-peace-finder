    ...
    <main dir="rtl" className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center sm:px-6 sm:py-20">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
          אתם לא חייבים לדעת איך קוראים לבעיה שלכם או איזה סוג טיפול עשוי לעזור לכם. פשוט כתבו מה מטריד אתכם או איזו
          עזרה אתם מחפשים, ומנוע החיפוש ימצא עבורכם את אנשי המקצוע המתאימים ביותר.
        </p>
