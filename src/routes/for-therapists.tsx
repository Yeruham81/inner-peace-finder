...
const therapistAdvantages = [
  ...
  },
  {
    ...
    description: "נרשמים בחינם ללא דמי מנוי חודשיים קבועים. משלמים רק עבור פניות שמתקבלות",
  },
  {
    icon: SlidersHorizontal,
    title: "כלי ניהול מתקדמים",
    description: "אזור אישי המאפשר לכם לנהל לקבוע תקרת תקציב חודשית, נתונים  המתאימה לכם ויכולים לנהל את הפעילות בהתאם לצורך.",
  },
];
