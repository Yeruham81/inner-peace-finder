          ...
          >
            <div className="space-y-2">
              <p className="text-xs text-muted-foreground">
                כתבו תיאור אישי ומקצועי של עצמכם, של הדרך שבה אתם עובדים ושל הניסיון שלכם. ציינו במפורש באילו מצבים,
                קשיים והתמודדויות אתם מסייעים, עם אילו אוכלוסיות אתם עובדים ובאילו תחומים יש לכם ניסיון מיוחד. תיאור
                מדויק ומפורט יעזור לנו להציג את הפרופיל שלכם לאנשים שמחפשים מענה המתאים לניסיון ולתחומי הטיפול שלכם.
              </p>

              <p className="text-xs text-muted-foreground">
                מומלץ להימנע מניסוחים כלליים בלבד, כמו „ליווי בתהליכי שינוי” או „טיפול בקשיים רגשיים”, ולפרט ככל האפשר
                מהם המצבים שבהם אתם מטפלים.
              </p>
            </div>
            <textarea
