  ...
  return (
    <>
      <AccountPageHeader
        eyebrow="כספים"
        title="חיובים"
        description="מעקב אחר חיובים עבור פניות, ניצול התקציב ותנועות שנרשמו בחשבון. מנגנון הסליקה עצמו טרם חובר."
        action={
          showExampleHistory ? (
          ...
          {onboarding.isLoading ? (
            ...
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-5 text-center">
              ...
              <p className="mt-1 text-xs leading-5 text-emerald-900/80">
                {paymentMethodKind === "test"
                  ...
                  : "אמצעי התשלום תקין ופעיל. אין צורך בפעולה נוספת."}
              </p>
            ...
            <div className="rounded-xl border border-dashed border-border bg-muted/30 p-5 text-center">
              ...
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                לאחר חיבור ספק החיוב ניתן יהיה להוסיף כאן אמצעי תשלום, חשבוניות והגדרות חיוב. עד אז לא ניתן להשלים את
                הגדרת אמצעי התשלום.
              </p>
              {isAdmin && (
                <Button
