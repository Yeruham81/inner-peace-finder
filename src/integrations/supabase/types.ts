  ...
  public: {
    ...
    Functions: {
      claim_therapist_by_invite: {
        Args: { _token_hash: string; _auth_user_id: string; _verified_email: string };
        Returns: string;
      };
      create_therapist_claim_invite: {
        Args: { _therapist_id: string; _email: string; _token_hash: string; _created_by: string; _expires_at: string };
        Returns: Database["public"]["Tables"]["therapist_claim_invites"]["Row"];
      };
      mark_therapist_as_admin_public_profile: { Args: { _therapist_id: string }; Returns: undefined };
      mark_therapist_claim_invite_sent: { Args: { _invite_id: string }; Returns: undefined };
      approve_therapist_profile_removal: {
        Args: { _request_id: string; _reviewer: string; _verification_method: string };
        Returns: string;
      };
