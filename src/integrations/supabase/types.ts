  ...
  public: {
    Tables: {
      ...
      admin_broadcast_recipients: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_broadcast_recipients_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "admin_broadcast_recipients_therapist_account_id_fkey"
      ...
      site_announcements: {
        ...
        Relationships: [
          {
            foreignKeyName: "site_announcements_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: true
            referencedRelation: "admin_broadcast_campaigns"
            referencedColumns: ["id"]
